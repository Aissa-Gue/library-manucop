                        ...
                        <form action="" method="post">
                            <div class="form-row justify-content-md-center mb-4">
                                <div class="input-group col-md-9">
                                    ...
                                    <input type="text" name="book_id" class="form-control col-md-3" placeholder="أدخل رقم الكتاب">
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_array($searchResult)) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="previewBook.php?book_id=<?php echo $row['book_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="editBook.php?book_id=<?php echo $row['book_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="delete.php?del_book_id=<?php echo $row['book_id'] ?>&book_title=<?php echo $row['book_title'] ?>" onclick="return confirm('هل أنت متأكد؟')">
