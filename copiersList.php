                        ...
                        <form action="" method="post">
                            <div class="form-row justify-content-md-center mb-1">
                                <div class="input-group col-md-10">
                                    ...
                                    <input type="number" name="cop_id" class="form-control col-md-3" placeholder="أدخل رقم الناسخ">


                                    <div class="input-group-prepend">
                                        <span class="input-group-text">اسم الناسخ</span>
                                    </div>
                                    <input list="copiers" name="full_name" class="form-control" placeholder="أدخل اسم الناسخ ، نسبته ، لقبه ، كنيته ...">
                                    <datalist id="copiers">
                                        <?php
                                        for ($i = 0; $i <= $lastKey; $i++) { ?>
                            ...
                            <div class="form-row justify-content-md-center mb-2">
                                <div class="input-group col-md-10">
                                    ...
                                    <input list="cities" name="city_name" class="form-control col-md-3" placeholder="أدخل مدينة الناسخ">
                                    <datalist id="cities">
                                        <?php
                                    ...
                                    <input list="countries" name="count_name" class="form-control" placeholder="أدخل بلد الناسخ">
                                ...
                                <?php while ($row = mysqli_fetch_array($searchResult)) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="previewCopier.php?cop_id=<?php echo $row['cop_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="editCopier.php?cop_id=<?php echo $row['cop_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="delete.php?del_cop_id=<?php echo $row['cop_id'] ?>&full_name=<?php echo $row['full_name'] ?>&last_name=<?php echo $row['last_name'] ?>" onclick="return confirm('هل أنت متأكد؟')">
