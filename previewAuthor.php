            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control text-center" value="<?php echo $auth_id ?>" name="auth_id" id="auth_id" readonly>
                    </div>
                </div>
                <!-- 2nd row -->
                <div class="row mt-3">
                    <div class="col-md-9">
                        ...
                        <input type="text" class="form-control" value="<?php echo $auth_name ?>" name="auth_name" id="auth_name" readonly>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="previewBook.php?book_id=<?php echo $row['book_id'] ?>"><?php echo $row['book_title'] ?></a>
                                        </td>
                                    </tr>
                            <?php }
                            } else {
