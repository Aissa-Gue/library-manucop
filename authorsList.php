                        ...
                        <form action="" method="post">
                            <div class="form-row justify-content-md-center mb-4">
                                <div class="input-group col-md-9">
                                    ...
                                    <input type="text" name="auth_id" class="form-control col-md-3" placeholder="أدخل رقم المؤلف">
                            ...
                            <tbody>
                                <?php while ($row = mysqli_fetch_array($searchResult)) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="previewAuthor.php?auth_id=<?php echo $row['auth_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="editAuthor.php?auth_id=<?php echo $row['auth_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            <a class="btn btn-outline-danger" href="delete.php?del_auth_id=<?php echo $row['auth_id'] ?>&auth_name=<?php echo $row['auth_name'] ?>" onclick="return confirm('هل أنت متأكد؟')">
